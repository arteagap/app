            ...
            <div class="headerwrapper">
                ...
                <div class="header-right">
                    ...
                    <div class="pull-right">
                        ...
                        <form class="form form-search" action="search-results.html" style="display: none;">
                            <input type="search" class="form-control" placeholder="Search" />
                        </form>
                        
                        <div class="btn-group btn-group-list btn-group-notification">
                              <p class="name-bis"><?php echo $this->auth->getempresa(); ?></p>
                        </div>                        
                        ...
                        <div class="btn-group btn-group-list btn-group-notification" >
                            ...
                            <div class="dropdown-menu pull-right">
                                ...
                                <ul class="media-list dropdown-list">
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="<?php echo base_url();?>assets/images/photos/user1.png" alt="">
                                    ...
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="<?php echo base_url();?>assets/images/photos/user2.png" alt="">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="<?php echo base_url();?>assets/images/photos/user3.png" alt="">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="<?php echo base_url();?>assets/images/photos/user4.png" alt="">
                                        <div class="media-body">
                        ...
                        <div class="btn-group btn-group-list btn-group-messages" style="display: none">
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                        ...
                        <div class="btn-group btn-group-option">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu">
                              ...
                              <li class="divider"></li>
                              <li><a href="<?php echo base_url('home/logout_user'); ?>"><i class="glyphicon glyphicon-log-out"></i>Cerrar Sesión</a></li>
                            </ul>
                        </div><!-- btn-group -->
